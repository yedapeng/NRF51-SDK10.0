...
#define BOOTLOADER_SETTINGS_ADDRESS     0x0003BC00                                                      /**< The field specifies the page location of the bootloader settings address. */
#endif
...
#define DFU_IMAGE_MAX_SIZE_FULL         (DFU_REGION_TOTAL_SIZE - DFU_APP_DATA_RESERVED+0x4000)                 /**< Maximum size of an application, excluding save data from the application. */
